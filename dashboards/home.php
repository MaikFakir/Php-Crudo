            ...
            <div class="menu-bar">
                <div class="menu">
                    ...
                    <ul class="menu-links">
                        ...
                        <li class="nav-link">
                            <a href="Dasboard_admin.html" target="principal">
                        ...
                        <li class="nav-link">
                            <a href="Inventario.html" target="principal">
                        ...
                        <li class="nav-link">
                            <a href="Dashboard_promociones.html" target="principal">
                                <i class='bx bx-wallet icon'></i>
                                <span class="text nav-text">Promociones</span>
                            </a>
                        </li>

                        <li class="nav-link">
                            <a href="../Dasboard Operador/Dashboard_Clientes.html" target="principal">
                                <i class='bx bx-wallet icon'></i>
